...
% 繰り返し回数
%合計40トライアル
repeatNum1 = 1; %くり返しが1回
%---------------------------------
cyberTime = 0.2; %cyberballの提示時間
...
try
    ...
    while trialNum < 4 %以下を4回繰り返す
    %------------%右から左(1トライアル目)の1
        for k = 1: repeatNum1 % ブロックの繰り返し
            %---------- 凝視点の呈示
        ...
        % 回答を待つ(1回目の分岐)
         ...
         if keyIsDown
            ...
            for k = 1: repeatNum1
             ...
             if keyIsDown
                 if keyCode(KbName('H')) %中央から左(5トライアル目)左左
                 for k = 1: repeatNum1
                     order = [1:imgNum];
                     for i = 1 : imgNum
                     imgFileName11 = char(imgFileList6(order(i)).name);
                 ...
                 [ keyIsDown, keyTime, keyCode ] = KbCheck;
                 if keyIsDown
                 if keyCode(KbName('H')) %中央から左(8トライアル目) %左左左
                 for k = 1: repeatNum1
                     order = [1:imgNum];
                     for i = 1 : imgNum
                     imgFileName11 = char(imgFileList6(order(i)).name);
                 ...
                 if keyCode(KbName('J')) %中央から右(8トライアル目)%左左右
                 for k = 1: repeatNum1
                     order = [1:imgNum];
                     for i = 1 : imgNum
                 ...
                 [ keyIsDown, keyTime, keyCode ] = KbCheck;
                 if keyIsDown
                 if keyCode(KbName('H')) %10トライアル目%左左右左
                 for k = 1: repeatNum1
                     order = [1:imgNum];
                     for i = 1 : imgNum
                     imgFileName11 = char(imgFileList6(order(i)).name);
                 ...
                 if keyCode(KbName('J')) %10トライアル目%左左右右
                     for k = 1: repeatNum1
                         order = [1:imgNum];
                         for i = 1 : imgNum
                         imgFileName9 = char(imgFileList5(order(i)).name);
            ...
            %2回目の分岐(右)
            if keyCode(KbName('J')) %中央から右(5トライアル目)%左右
            for k = 1: repeatNum1
                order = [1:imgNum];
                for i = 1 : imgNum
                imgFileName9 = char(imgFileList5(order(i)).name);
            ...
            [ keyIsDown, keyTime, keyCode ] = KbCheck;
            if keyIsDown
            if keyCode(KbName('H')) %中央から左(8トライアル目)%左右左
            for k = 1: repeatNum1
                order = [1:imgNum];
                for i = 1 : imgNum
                imgFileName11 = char(imgFileList6(order(i)).name);
            ...
            [ keyIsDown, keyTime, keyCode ] = KbCheck;
            if keyIsDown
            if keyCode(KbName('H')) %10トライアル目%左右左左
            for k = 1: repeatNum1
                order = [1:imgNum];
                for i = 1 : imgNum
                imgFileName11 = char(imgFileList6(order(i)).name);
            ...
            if keyCode(KbName('J')) %10トライアル目%左右左右
                for k = 1: repeatNum1
                    order = [1:imgNum];
                    for i = 1 : imgNum
                    imgFileName9 = char(imgFileList5(order(i)).name);
            ...
            if keyCode(KbName('J')) %中央から右(8トライアル目)%左右右
            for k = 1: repeatNum1
                order = [1:imgNum];
                for i = 1 : imgNum
                imgFileName9 = char(imgFileList5(order(i)).name);
            ...
            [ keyIsDown, keyTime, keyCode ] = KbCheck;
            if keyIsDown
                if keyCode(KbName('H')) %10トライアル目%左右右左
                for k = 1: repeatNum1
                    order = [1:imgNum];
                    for i = 1 : imgNum
                    imgFileName11 = char(imgFileList6(order(i)).name);
                ...
                if keyCode(KbName('J')) %10トライアル目%左右右右
                for k = 1: repeatNum1
                    order = [1:imgNum];
                    for i = 1 : imgNum
                    imgFileName9 = char(imgFileList5(order(i)).name);
            ...
            while 1 % while 文の中をぐるぐる回ります。
            [ keyIsDown, keyTime, keyCode ] = KbCheck;
            if keyIsDown %2回目の分岐(右)
            if keyCode(KbName('H')) %5トライアル目%右左
            for k = 1: repeatNum1
                order = [1:imgNum];
                for i = 1 : imgNum
                imgFileName11 = char(imgFileList6(order(i)).name);
            ...
            if keyCode(KbName('J')) %2回目の分岐(5トライアル目)%右右
            for k = 1: repeatNum1
                order = [1:imgNum];
                for i = 1 : imgNum
                imgFileName9 = char(imgFileList5(order(i)).name);
            ...
            if keyCode(KbName('J')) %中央から右(8トライアル目)%右右右
            for k = 1: repeatNum1
                order = [1:imgNum];
                for i = 1 : imgNum
                imgFileName9 = char(imgFileList5(order(i)).name);
            ...
            [ keyIsDown, keyTime, keyCode ] = KbCheck; % キーが押されたか、そのときの時間、どのキーか、の情報を取得する
            if keyIsDown
            if keyCode(KbName('H')) %10トライアル目%右右右左
            for k = 1: repeatNum1
                order = [1:imgNum];
                for i = 1 : imgNum
                imgFileName11 = char(imgFileList6(order(i)).name);
            ...
            if keyCode(KbName('J')) %10トライアル目%右右右右
            for k = 1: repeatNum1
                order = [1:imgNum];
                for i = 1 : imgNum
                imgFileName9 = char(imgFileList5(order(i)).name);
